...
const UpsellTracker = {
    ...
    setupListeners: function() {
        ...
        document.querySelectorAll('a[href*="appdetect.shop"]').forEach(btn => {
        ...
        document.querySelectorAll('.decline-link, a[href*="up2"], a[href*="up3"], a[href*="up4"], a[href*="up5"], a[href*="up6"], a[href*="up7"], a[href*="thankyou"]').forEach(link => {
            ...
            if (!link.href.includes('appdetect.shop') && !link.classList.contains('btn-mega')) {
    ...
    setupEngagementTracking: function() {
        ...
        window.addEventListener('scroll', function() {
            ...
            if (!trackedCTA) {
                const ctaButton = document.querySelector('.btn-primary.btn-mega, a[href*="appdetect.shop"]');
                if (ctaButton) {
